...
def serialize_post_optimized(post):
    return {
        ...
        "published_at": post.published_at,
        "slug": post.slug,
        "tags": [serialize_tag(tag) for tag in post.tags.annotate(popular_tags=Count("posts"))],
        "first_tag_title": post.tags.all()[0].title,
    }
...
def serialize_tag(tag):
    return {
        "title": tag.title,
        "posts_with_tag": tag.popular_tags,
    }
...
def post_detail(request, slug):
    ...
    serialized_post = {
        ...
        "published_at": post.published_at,
        "slug": post.slug,
        "tags": [serialize_tag(tag) for tag in related_tags.annotate(popular_tags=Count("posts"))],
    }
